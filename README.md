...
![Branches](https://img.shields.io/badge/branches-93.19%25-brightgreen.svg?style=flat)
...
| GET    | `/offers`                       | —               | List offers. Query params: `title`, `priceMin`, `priceMax`, `owner` (a user id, to list that seller's offers), `sort` (`price-asc` \| `price-desc`, default ascending), `page` (default 1, 20 per page).                                                                                   |
